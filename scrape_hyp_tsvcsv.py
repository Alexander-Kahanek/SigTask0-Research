...
def create_hyp_tsvcsv(languages=['gml', 'nno', 'deu', 'eng', 'isl'], devfilepath='task0-data/DEVELOPMENT-LANGUAGES/', tsvfilepath='checkpoints/sigmorphon20-task0/', scrapetsv=True, createhyp=True):
    '''
    ...
    def align_filepaths(languages, devfilepath, tsvfilepath):
        '''
        ...
        if devfilepath in 'task0-data/DEVELOPMENT-LANGUAGES/' and tsvfilepath in 'checkpoints/sigmorphon20-task0/':
    ...
    def main(languages, devfilepath, tsvfilepath, scrapetsv, createhyp):

        # get all filepaths for tsv and dev files
        tsvlist, devlist = align_filepaths(languages, devfilepath, tsvfilepath)
    ...
    main(languages, devfilepath, tsvfilepath, scrapetsv, createhyp)
